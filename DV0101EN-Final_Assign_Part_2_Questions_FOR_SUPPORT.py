...
app.layout = html.Div([
    ...
    html.H1(style={'textAlign':'left', 'color':'#503D36', 'font-size':'24px'}),#May include style for title
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        return [
            ...
            html.Div(className='chart-item', children=[R_chart3, R_chart4], style={'flex': '1'})
        ]
